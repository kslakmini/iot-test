...
router.get('/me', checkAuth, async (req, res) => {
  try {
    const data = await User.findOne(
      { id: req.user._id, status: 'active' },
      'title firstName lastName fullName role phoneNumber companyName location image numberofEmployess description address email openTime closeTime district'
    );
